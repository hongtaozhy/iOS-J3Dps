...
@interface HTIntroduceViewController ()

@end

@implementation HTIntroduceViewController
...
- (void)viewDidLoad
{
    ...
    self.centerView.backgroundColor = [UIColor colorWithPatternImage:[UIImage imageNamed:@"qidai"]];
    // Set parameters
